...
uwsgi --http-socket 0.0.0.0:5000 --manage-script-name --mount /cuizinart=main:app --master --processes 4 --threads 2 --logto ${LOG_DIRECTORY}/cuizinart_uwsgi.log --logfile-chmod 666
